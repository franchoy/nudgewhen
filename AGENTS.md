...
**Document status:** Accepted — stable governance; v0.1.2 Phases 0 through 3 Complete; Phase 4 current; Phases 4 through 7 Planned
...
- **Active release charter:** `docs/releases/v0.1.2/release-charter.md`
- **Active phase list:** `docs/releases/v0.1.2/phase-list.md`
- **Current phase:** Phase 4 — Minimal Android Reminder UI (current lifecycle phase; formal status `Planned`; implementation not started)

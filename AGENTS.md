...
- **Active release charter:** `docs/releases/v0.1.4/release-charter.md`
- **Active phase list:** `docs/releases/v0.1.4/phase-list.md`
- **Current lifecycle state:** Phase 0 — Release Definition & Bootstrap — is `Complete`; Phase 1 — Done State Architecture Contract — is `Planned`; Phases 2 through 7 are `Planned`; Phase 1 implementation has not started; phase model `1 Complete / 7 Planned`.
...
- **Current lifecycle phase:** `Phase 1 — Done State Architecture Contract`
...
- **Persistence-format decision:** `PHASE_1_REQUIRED` (Phase 0 does not select a concrete representation; the final persistence representation decision is reserved for the Phase 1 architecture contract)

...
- **Active release charter:** `docs/releases/v0.1.4/release-charter.md`
- **Active phase list:** `docs/releases/v0.1.4/phase-list.md`
- **Current lifecycle state:** Phase 0 — Release Definition & Bootstrap — is `Complete`; Phase 1 — Done State Architecture Contract — is `Complete`; Phase 2 — Done State Domain Implementation & JVM Proof — is `Complete`; Phases 3 through 7 are `Planned`; phase model `3 Complete / 5 Planned`; Phase 3 — Persistence Compatibility / Migration Proof — is the next lifecycle phase and has not started.
...
- **Current lifecycle phase:** `Phase 3 — Persistence Compatibility / Migration Proof`
...
- **Persistence-format decision:** `NWR2_WITH_NWR1_BACKWARD_LOAD` (Phase 1 selected NWR2 writes with backward NWR1 loading and lazy same-file migration; current production/released persistence remains NWR1; Phase 3 owns implementation, backward-load behavior, lazy same-file migration, and persistence proof)

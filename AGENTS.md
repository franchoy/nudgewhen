...
**Document status:** Accepted — stable governance; v0.1.2 Phases 0 through 4 Complete; Phase 5 current; Phases 5 through 7 Planned
...
- **Active release charter:** `docs/releases/v0.1.2/release-charter.md`
- **Active phase list:** `docs/releases/v0.1.2/phase-list.md`
- **Current phase:** Phase 5 — Integration & Device Validation (current lifecycle phase; formal status `Planned`; implementation not started)

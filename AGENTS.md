...
- **Active release charter:** `docs/releases/v0.1.4/release-charter.md`
- **Active phase list:** `docs/releases/v0.1.4/phase-list.md`
- **Current lifecycle state:** Phase 0 — Release Definition & Bootstrap — is `Complete`; Phase 1 — Done State Architecture Contract — is `Complete`; Phases 2 through 7 are `Planned`; phase model `2 Complete / 6 Planned`; Phase 2 is the next lifecycle phase and has not started.
...
- **Phase model:** `2 Complete / 6 Planned`
- **Current lifecycle phase:** `Phase 2 — Done State Domain Implementation & JVM Proof`

...
NudgeWhen is currently in the `v0.1.3` release train, **Editable Local Reminders**, on the single branch `release/v0.1.3`. Phases 0 through 1 are complete; Phase 0 — Release Definition & Bootstrap — is formally closed; Phase 1 — Editing Architecture Contract — is formally closed; Phases 2 through 7 remain `Planned`; 2 Complete / 6 Planned. Phase 2 — Editing Domain Implementation & JVM Proof — is the next lifecycle phase, remains `Planned`, and has not started. The Phase 1 architecture contract is landed and exact-head CI accepted. The completed `v0.1.2` — **Local Reminder Foundation** — release remains historical and provides the inherited local reminder baseline. Phases 0 and 1 did not implement reminder editing. This synchronized lifecycle state does not claim v0.1.3 is merged, tagged, published, or release-ready.
...
These are long-term goals. Voice-first capture and contextual-reminder behavior remain future goals. The completed `v0.1.2` Local Reminder Foundation supplies the inherited minimal local reminder lifecycle and accepted one-device Android 13 runtime evidence. Phase 0 — Release Definition & Bootstrap — and Phase 1 — Editing Architecture Contract — of the active `v0.1.3` release are formally closed; Phases 2 through 7 remain `Planned`; 2 Complete / 6 Planned. Phase 2 — Editing Domain Implementation & JVM Proof — is next, remains `Planned`, and has not started. Phases 0 and 1 did not implement reminder editing.
...
Historical `v0.1.2` — **Local Reminder Foundation** — is complete and provides the inherited local reminder baseline. The active `v0.1.3` release is **Editable Local Reminders**. Phases 0 through 1 are complete; Phase 0 — Release Definition & Bootstrap — and Phase 1 — Editing Architecture Contract — are formally closed; Phases 2 through 7 remain `Planned`; 2 Complete / 6 Planned. Phase 2 — Editing Domain Implementation & JVM Proof — is the next lifecycle phase, remains `Planned`, and has not started. Reminder editing was not implemented by Phases 0 or 1. This synchronized lifecycle state does not claim v0.1.3 is merged, tagged, published, or release-ready.

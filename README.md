...
These are long-term goals. Voice-first capture and contextual-reminder behavior remain future goals. The completed `v0.1.2` Local Reminder Foundation supplies the inherited minimal local reminder lifecycle and accepted one-device Android 13 runtime evidence. The released `v0.1.4` release — **Mark Reminder Done** — is at Phase 0 `Complete`, Phase 1 `Complete`, Phase 2 `Complete`, Phase 3 `Complete`, Phase 4 `Complete`, Phase 5 `Complete`, Phase 6 `Complete`, Phase 7 `Complete` and formally complete; phase model: `8 Complete / 0 Planned`; no lifecycle phase remains inside the accepted eight-phase v0.1.4 model. Phase 0 froze the release definition; Phase 1 froze the done-state architecture. Phase 2 done-state domain implementation is `LANDED_AND_EXACT_HEAD_CI_ACCEPTED`. Phase 3 persistence compatibility / migration implementation is `LANDED_AND_EXACT_HEAD_CI_ACCEPTED`. Phase 4 bounded source-level done-state Compose integration is `LANDED_AND_EXACT_HEAD_CI_ACCEPTED`; Phase 5 integrated/device validation and Android identity alignment is `LANDED_AND_EXACT_HEAD_CI_ACCEPTED`. Phase 7 — Full Pre-Release Gate — is formally complete following the accepted Phase-7-D independent candidate audit, Phase-7-E native nudge-land landing, and Phase-7-F terminal maintainer acceptance; no lifecycle phase remains inside the accepted eight-phase v0.1.4 model. The v0.1.4 user-facing done-state promise is implemented and accepted through Phase 5; the integrated audit/reconciliation is implemented in Phase 6. v0.1.4 has been merged into `main`, tagged with the annotated `v0.1.4` tag, and published as a GitHub Release; post-v0.1.4 maintenance is complete and the maintenance window is formally closed; v0.1.5 has not started. The completed `v0.1.3` historical release — **Editable Local Reminders** — is at phase model `8 Complete / 0 Planned`: Phase 0 — Release Definition & Bootstrap — and Phase 1 — Editing Architecture Contract — are formally closed; Phase 2 — Editing Domain Implementation & JVM Proof — is `Complete`; Phase 3 — Persistence Compatibility Proof — is `Complete`; Phase 4 — Minimal Compose Editing UX — is `Complete`; Phase 5 — Integration & Device Validation — is `Complete`; Phase 6 — Integrated Audit & Reconciliation — is `Complete`; Phase 7 — Full Pre-Release Gate — is `Complete` in this closure-synchronization candidate. Phase 6-C real-use nudge-land evidence is `Complete` at landing-core commit `844db073394b9d76e847f4078b7eb12b79b07a78` (terminal state `LANDED / S10_LANDED`); the completed single-use Phase 6-C authorization `nudgewhen-v0.1.3-phase6c-first-use-001` is `PROHIBITED` from reuse. Phase 7 — Full Pre-Release Gate — is `Complete` in this closure-synchronization candidate. Phases 0 and 1 of `v0.1.3` did not implement reminder editing; Phase 2 implemented only the frozen edit domain API and its deterministic JVM proof and did not implement persistence across edit or any user-facing editing flow; Phase 3 proved persistence compatibility and did not implement any user-facing editing flow; Phase 4 implemented the bounded Compose editing UX on `ReminderScreen` and did not perform integrated/device validation or Android identity alignment. Current-facing Phase-7 pre-release evidence: accepted at first-landed HEAD `4213fd2f6750a71bc91d7e3516e043bf037aaff1` with exact-head hosted CI success, standard regression `244 / OK`, definitive clean validator `41 / 0 / 0`, and `release_gate=SATISFIED`. At that retained Phase-7 pre-release evidence point, release readiness was `NO`; merged was `NO`; tagged was `NO`; published was `NO`. General Android compatibility: `NOT_CLAIMED`. Multi-device validation: `NOT_CLAIMED`. Production readiness: `NOT_CLAIMED`.
...
The project follows a phased release train on the single branch `release/vX.Y.Z`. The `v0.1.4` release — **Mark Reminder Done** — has been released and closed on the single branch `release/v0.1.4`; `v0.1.5` is not started. NudgeWhen is currently in the `v0.1.4` release train for retained release-contract and governance identity only; v0.1.4 itself is released and closed. The current active branch is `release/v0.1.4` as retained by the current release contract until separately authorized v0.1.5 Phase 0; this retained branch identity does not mean v0.1.4 development remains open. Phase 0 — Release Definition & Bootstrap — is `Complete`; Phase 1 — Done State Architecture Contract — is `Complete`; Phase 2 — Done State Domain Implementation & JVM Proof — is `Complete`; Phase 3 — Persistence Compatibility / Migration Proof — is `Complete`; Phase 4 — Minimal Compose Integration — is `Complete`; Phase 5 — Integration & Device Validation — is `Complete`; Phase 6 — Integrated Audit & Reconciliation — is `Complete`; Phase 7 — Full Pre-Release Gate — is `Complete` and formally complete; phase model: `8 Complete / 0 Planned`; no lifecycle phase remains inside the accepted eight-phase v0.1.4 model. Phase 2 done-state domain implementation is `LANDED_AND_EXACT_HEAD_CI_ACCEPTED`. Phase 3 persistence compatibility / migration implementation is `LANDED_AND_EXACT_HEAD_CI_ACCEPTED`. Phase 4 bounded source-level done-state Compose integration is `LANDED_AND_EXACT_HEAD_CI_ACCEPTED`. Phase 5 — Integration & Device Validation — has landed Android identity alignment and integrated/device validation and is `Complete`. Phase 6 — Integrated Audit & Reconciliation — is `Complete`; Phase 7 — Full Pre-Release Gate — is `Complete` and formally complete following the accepted Phase-7-D independent candidate audit, Phase-7-E native nudge-land landing, and Phase-7-F terminal maintainer acceptance; no lifecycle phase remains inside the accepted eight-phase v0.1.4 model. The completed `v0.1.3` release is historical and provides the inherited edit-on-text baseline; `v0.1.2`, `v0.1.1`, and `v0.1.0` remain historical evidence.
